...
<html>
    <head>
        <meta charset="UTF-8">
        <link rel="stylesheet" href="./estiloFormularioModUsu.css" />
        ...
        <section class="stark-login">
            ...
            if (!empty($_GET['usuario'])) {
                ...
                if (comprobarUsuario($_GET['usuario'])) {
                    // Si el usuario existe se cambia el 'action' a mostrarDatosMod.php
                    echo "mostrarDatosMod.php";
                } else {
                    // si no existe a formularioModUsu.php
                    echo "formularioModUsu.php";
                }
            } else {
